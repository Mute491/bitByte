                ...
                <div class="card-panel grey darken-4 z-depth-1">
                    <div class="row valign-wrapper">
                        <div class="col s4 l2 square-container">
                            <?php echo('<img id="propic" src="'.$userData["immagine_profilo"].'" class="circle responsive-img">')?>
                        </div>
                ...
                <div class="card-panel grey darken-4 z-depth-1">
                    <div class="row valign-wrapper">
                        <div class="col s8 white-text">
                            <p>
                                <h6>Contatti</h6>
                                <i id="telefono" class="material-icons prefix"><?php echo($userData["telefono_contatto"])?></i>
                                <br>
                                <i id="email" class="material-icons prefix"><?php echo($userData["email"])?></i>
                            </p>
                        </div>
                    </div>
                </div>
